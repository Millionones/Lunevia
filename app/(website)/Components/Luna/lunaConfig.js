...
// Full-figure standing pose for the homepage-hero character — Luna waving in her
// festive dress, shown at full size in the bottom-right corner. On scroll she
// collapses into the round avatar launcher. Falls back to the round avatar if the
// pose image is missing. (Rename this file if you swap the art later — next/image
// caches by URL. See lunevia-nextimage-asset-cache.)
export const LUNA_POSE_HERO = "/luna/luna-hero-full.png"
