...
const Destinations = ({ data = [], showViewAll = true, heading, subtext }) => {
  return (
    <section className='destination destination--full bg-transparent'>
      <div className='cmpad'>
        <div className='destination-header destination-header--center'>
          <h4>{heading || 'Discover Our Destinations'}</h4>
          <p>{subtext || 'Each LUNEVIA property is a world of its own — united by philosophy, distinct in character.'}</p>
          {showViewAll && (
