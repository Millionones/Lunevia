            ...
            <div className="cmpad">
                <Reveal className="mx-auto max-w-3xl text-center">
                    ...
                    <h2 className="mt-4 text-3xl font-bold leading-tight tracking-tight text-neutral-900 dark:text-white md:text-5xl">
                        Travel that inspires, restores, and transforms
                    </h2>
                    <p className="mx-auto mt-6 max-w-xl leading-relaxed text-neutral-600 dark:text-neutral-400">
                        Every destination invites you to experience Kerala in a way that is intimate,
                        meaningful, and unforgettable.
                    </p>
                    <div className="mt-9 flex justify-center">
                        <LiquidLink href="/destinations">Explore Our Destinations</LiquidLink>
                    </div>
                </Reveal>
            </div>
        </section>
