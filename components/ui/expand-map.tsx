...
// Adapted for this project: inline `hsl(var(--foreground) / a)` was replaced with
// concrete rgba of the brand `foreground` (#1b1c1c), since this codebase defines
// colors as flat hex in tailwind.config.ts and has no matching :root CSS vars.
const FG_05 = "rgba(27, 28, 28, 0.05)"
const FG_08 = "rgba(27, 28, 28, 0.08)"
          ...
          <div className="flex items-start justify-between">
            ...
            <motion.div
              ...
              animate={{
                ...
                backgroundColor: isHovered ? FG_08 : FG_05,
              }}
