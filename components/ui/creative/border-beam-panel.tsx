...
function useReducedMotion(): boolean {
  ...
  React.useEffect(() => {
    ...
    // Client-only media-query re-sync after mount; the SSR value came from the initializer.
...
function BorderBeamPanelBase({
  ...
  // Keep the latest speeds available to the rAF loop without re-subscribing.
  // Synced in an effect (post-commit) rather than mutated during render.
  React.useEffect(() => {
